...
<body>
  ...
  <img class="logo" src="https://raw.githubusercontent.com/agamula90/the-littlest-jupyterhub/master/docs/images/logo/logo.png">
...
def main():
    ...
    tljh_repo_path = os.environ.get(
        ...
        'git+https://github.com/agamula90/the-littlest-jupyterhub.git'
    )
